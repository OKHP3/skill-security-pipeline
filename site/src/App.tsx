...
export default function App() {
  ...
  return <>
    ...
    <footer className="site-footer"><div className="container"><div className="footer-main"><a className="footer-wordmark" href="#overview"><Icon name="shield" />Skillz Shield</a><p>An open-source project from <a href="https://overkillhill.com/">OverKill Hill P³™</a>.</p><div className="footer-links"><a href={REPOSITORY}>GitHub</a><a href={`${REPOSITORY}/blob/main/SECURITY.md`}>Security</a><a href={`${REPOSITORY}/blob/main/LICENSE`}>MIT license</a></div></div><div className="footer-bottom"><p>Built with Vite, React, TypeScript &amp; Tailwind CSS. Hosted on GitHub Pages.</p><p>Cisco and NVIDIA retain their own licenses. No vendor endorsement implied.</p></div></div></footer>
  </>;
}
